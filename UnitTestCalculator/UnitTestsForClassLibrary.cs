...
namespace UnitTestCalculator
{
    ...
    public class UnitTestsForClassLibrary
    {
        ...
        {//this addition test method test the addition result with 0 as second number
            double additionresult;
        ...
        {//this addition test method test the addition result with both positive numbers
            double additionresult;
        ...
        {//this addition test method test the addition result with both negative numbers
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(-20, -20);
            Assert.AreEqual(-40, additionresult);
        }
        ...
        {//this addition test method test the addition result with first negative and second positive number
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(-20, 20);
        ...
        {//this addition test method test the addition result with first positive and second negative  number
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(20, -20);
            Assert.AreEqual(0, additionresult);
        }
        ...
        {//this addition test method test the addition result with first 0 and second negative number
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(0, -20);
            Assert.AreEqual(-20, additionresult);
        }
        ...
        {//this addition test method test the addition result with first negative and second 0 number
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(-20, 0);
            Assert.AreEqual(-20, additionresult);
        }
        ...
        {//this addition test method test the addition result with both 0 number
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(0, 0);
            Assert.AreEqual(0, additionresult);
        }
        [TestMethod]
        public void CheckClassLibrarySolveAdditionChallengeTestMethod10()
        {//this addition test method test the addition result with first large and second negative number
            double additionresult;
            additionresult = CalculatorTasks.AdditionTask(100000, -1);
        ...
        {//this subtraction test method test the subtraction result with 0 as first number
        ...
        {//this subtraction test method test the subtraction result with 0 as second number
            double subtractionresult;
        ...
        {//this subtraction test method test the subtraction result with both positive  numbers
            double subtractionresult;
        ...
        {//this subtraction test method test the subtraction result with both negative numbers
            double subtractionresult;
            subtractionresult = CalculatorTasks.SubtractionTask(-30, 30);
        ...
        {//this subtraction test method test the subtraction result with first positive and second negative number
            double subtractionresult;
            subtractionresult = CalculatorTasks.SubtractionTask(30, -30);
            Assert.AreEqual(60, subtractionresult);
        }
        ...
        {//this subtraction test method test the subtraction result with first 0 and second negative number
            double subtractionresult;
            subtractionresult = CalculatorTasks.SubtractionTask(0, -30);
            Assert.AreEqual(30, subtractionresult);
        }
        ...
        {//this subtraction test method test the subtraction result with first negative and second 0 number
            double subtractionresult;
            subtractionresult = CalculatorTasks.SubtractionTask(-30, 0);
            Assert.AreEqual(-30, subtractionresult);
        }
        ...
        {//this subtraction test method test the subtraction result with both 0 number
            double subtractionresult;
            subtractionresult = CalculatorTasks.SubtractionTask(0, 0);
            Assert.AreEqual(0, subtractionresult);
        }
        [TestMethod]
        public void CheckClassLibrarySolveSubtractionChallengeTestMethod10()
        {//this subtraction test method test the subtraction result with first large value and second 0 number
            double subtractionresult;
            subtractionresult = CalculatorTasks.SubtractionTask(100000, -1);
        ...
        {//this multiplication test method test the product result with 0 as first number
        ...
        {//this multiplication test method test the product result with 0 as second number
            double multiplicationresult;
        ...
        {//this multiplication test method test the product result with both positive numbers
            double multiplicationresult;
        ...
        {//this multiplication test method test the product result with one negative and other positive number
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(-40, 40);
            Assert.AreEqual(-1600, multiplicationresult);
        }
        ...
        {//this multiplication test method test the product result with one positive and other negative number
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(40, -40);
            Assert.AreEqual(-1600, multiplicationresult);
        }
        ...
        {//this multiplication test method test the product result with both negative
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(-40, -40);
            Assert.AreEqual(1600, multiplicationresult);
        }
        ...
        {//this multiplication test method test the product result with one 0 and other negative number
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(0, -40);
            Assert.AreEqual(0, multiplicationresult);
        }
        ...
        {//this multiplication test method test the product result with one negative and other 0 
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(-40, 0);
            Assert.AreEqual(0, multiplicationresult);
        }
        ...
        {//this multiplication test method test the product result with both 0 numbers
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(0, 0);
            Assert.AreEqual(0, multiplicationresult);
        }
        [TestMethod]
        public void CheckClassLibrarySolveMultiplicationChallengeTestMethod10()
        {//this multiplication test method test the product result with one large and other negative number
            double multiplicationresult;
            multiplicationresult = CalculatorTasks.MultiplicationTask(100000, -1);
        ...
        {//this division test method test the quotient  with 0 as first number
        ...
        {//this division test method test the quotient  with 0 as second number
            double divisionresult;
        ...
        {//this division test method test the quotient  with both positive numbers
            double divisionresult;
        ...
        {//this division test method test the quotient  with first negative and second positive number
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(-50, 50);
            Assert.AreEqual(-1, divisionresult);
        }
        ...
        {//this division test method test the quotient  with first positive and second negative number
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(50, -50);
            Assert.AreEqual(-1, divisionresult);
        }
        ...
        {//this division test method test the quotient  with both negative numbers
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(-50, -50);
            Assert.AreEqual(1, divisionresult);
        }
        ...
        {//this division test method test the quotient  with one 0 and other negative numbers
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(0, -50);
            Assert.AreEqual(0, divisionresult);
        }
        ...
        {//this division test method test the quotient  with one negative and other 0 number
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(-50, 0);
            Assert.AreEqual(-1, divisionresult);
        }
        ...
        {//this division test method test the quotient  with both 0 numbers
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(0, 0);
            Assert.AreEqual(-1, divisionresult);
        }
        [TestMethod]
        ...
        {//this division test method test the quotient  with one large value and other negative number
            double divisionresult;
            divisionresult = CalculatorTasks.DivisionTask(100000, -1);
